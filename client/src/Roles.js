    ...
    try {
      ...
      if (reciept) {
        ...
        try {
          ...
          const { data } = await axios.post("https://mongodb-api-production-bca0.up.railway.app/add/rawmaterial", latestRawMaterial);
    ...
    try {
      ...
      if (reciept) {
        ...
        try {
          ...
          const { data } = await axios.post("https://mongodb-api-production-bca0.up.railway.app/add/manufacturer", latestManufacturer);
    ...
    try {
      ...
      if (reciept) {
        ...
        try {
          ...
          const { data } = await axios.post("https://mongodb-api-production-bca0.up.railway.app/add/retailer", latestRetailer);
